...
def send_email(interval, recipients, data, dv01_data, cvar_data, curr_exp_data):
    ...
    def generate_pnl_charts(data, interval):
        ...
        # Futures Charts
        futures_data = data[data["Book Name"].isin(['USD rates', 'DM Rates', 'Equity trading', 'Short term trading', 'Commodities'])]
        ...
        fig3.add_trace(go.Bar(x=swaps_data['Description'], y=swaps_data['Quantity'], name='Quantity'), secondary_y=False)
    ...
    """
    images = ["images/total_pnl.png", "images/fx_positions.png", "images/futures_positions.png", "images/swaps_positions.png", "images/options_positions.png"]
